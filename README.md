...
**Mobile** — Flutter · Dart · Riverpod · Provider · Firebase Cloud Messaging · Kotlin · UIKit/Swift
**Backend** — Django · Django REST Framework · FastAPI · SQLAlchemy · Alembic · PostgreSQL
**Frontend** — React · Vue.js · TypeScript · TailwindCSS
**Integrations** — OpenPay · CFDI/SAT · Firebase Admin SDK · JWT · Webhooks
**Infra** — Docker · Nginx · uWSGI · Git · Linux

---

## Contact

- **LinkedIn**: [linkedin.com/in/davidtorrres](https://www.linkedin.com/in/davidtorrres)
- **X (Twitter)**: [@deybytroide](https://x.com/deybytroide?t=CGFKX8Bo80k521ESL7zX1Q&s=09)
